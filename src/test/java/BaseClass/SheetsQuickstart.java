...
public class SheetsQuickstart extends CommonUtils{
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT)
            throws IOException {
        // Load client secrets.
        File credentialsFile = new File("src/test/resources/credentials.json");
        InputStream in = Files.newInputStream(credentialsFile.toPath());
...
//    public static void main(String... args) throws IOException, GeneralSecurityException {
    ...
    public static void fetchAllLocatorsFromSheet() throws IOException, GeneralSecurityException {
...
//            fileOut.close();
    ...
    public static void fetchLoginCredentials() throws IOException, GeneralSecurityException {
        final NetHttpTransport HTTP_TRANSPORT = GoogleNetHttpTransport.newTrustedTransport();
        final String spreadsheetId = "1qUdsEf7CEd6z9hW8Jl1264sF66VEIcSlW5Cu5h4iuM4";
...
//            fileOut.close();
    ...
    public static void fetchModulesAndRunTestNgSuites() throws IOException, GeneralSecurityException {
        final NetHttpTransport HTTP_TRANSPORT = GoogleNetHttpTransport.newTrustedTransport();
        final String spreadsheetId = "1qUdsEf7CEd6z9hW8Jl1264sF66VEIcSlW5Cu5h4iuM4";
        ...
        for (String className : executionList) {
            ...
            else if (className.contains("Reg")) {
                testClass = new XmlClass("RegressionSuite."+className);
            }
            else {
    ...
    public static void fetchAppConfigs() throws IOException, GeneralSecurityException {
        final NetHttpTransport HTTP_TRANSPORT = GoogleNetHttpTransport.newTrustedTransport();
        final String spreadsheetId = "1qUdsEf7CEd6z9hW8Jl1264sF66VEIcSlW5Cu5h4iuM4";
        final String range = "AppConfigs-Android!A2:B";
        Properties properties = new Properties();
        ...
        if (values == null || values.isEmpty()) {
            ...
            fileOut = new FileOutputStream(AppConfigFilePath);
            properties.store(fileOut, "Login Credentials");
//            fileOut.close();
        }
    }
